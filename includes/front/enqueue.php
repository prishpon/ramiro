...
function rmr_enqueue() {
  wp_register_style(
    'rmr_font_rubik_and_pacifico',
  ...
  wp_enqueue_style('rmr_font_rubik_and_pacifico');
  wp_enqueue_style('rmr_bootstrap_icons');
  wp_enqueue_style('rmr_theme');
}